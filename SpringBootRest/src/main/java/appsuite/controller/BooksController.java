...
public class BooksController {
	...
	public ResponseEntity<String> addBook(@RequestBody Book book) {
		...
		if (bookService.findOne(book.getId()) != null) {
			return new ResponseEntity<String>(
					"Book with id >> " + book.getId() + " already available wither delete it first or changes Id",
					HttpStatus.OK);
		}
	...
	public ResponseEntity<String> updateBook(@RequestBody Book book, @PathVariable("id") String id) {
