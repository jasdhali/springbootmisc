...
public interface CountryLanguageRepository extends JpaRepository<CountryLanguage, CountryLangPK> {
 ...
 */
	//public List<CountryLanguage> findByIdPartiallyWithExample(String 	countryCode,String 	language)
}
